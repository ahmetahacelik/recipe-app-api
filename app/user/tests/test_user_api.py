...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exist(self):
        """Test creatings user that already exist fails"""
        payload = {
            "email" : "test@test.com",
            "password" : "testpass",
            "name" : "Test name"
    ...
    def test_password_too_short(self):
        """Test creating password must be more than 5 characters"""
    ...
    def test_create_token_no_user(self):
        """Test that token is not create if user doesnt exist"""
        payload = {
            "email" : "test@test.com",
            "password" : "testpass",
        }
    ...
    def test_retrieve_user_unauthorized(self):
        """Test that authnetication is required for users"""
